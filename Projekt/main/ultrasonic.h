 ...
 *         - ::ESP_ERR_ULTRASONIC_PING         - Invalid state (previous ping is
 * not ended)
 *         - ::ESP_ERR_ULTRASONIC_PING_TIMEOUT - Device is not responding
 *         - ::ESP_ERR_ULTRASONIC_ECHO_TIMEOUT - Distance is too big or wave is
 * scattered
 */
 ...
 *
 * This function measures the distance by taking into account the temperature of
 * the air, which affects the speed of sound. This method improves the accuracy
 * of measurements in various environmental conditions.
 *
 * @param dev Pointer to the device descriptor
 * @param max_distance Maximal distance to measure, meters
 * @param[out] distance Distance in meters
 ...
 *
 * Similar to ultrasonic_measure_temp_compensated but provides the distance in
 * centimeters. It factors in the temperature of the air for more accurate
 * measurements across a range of environmental conditions.
 *
 * @param dev Pointer to the device descriptor
 * @param max_distance Maximal distance to measure, centimeters
 * @param[out] distance Distance in centimeters
